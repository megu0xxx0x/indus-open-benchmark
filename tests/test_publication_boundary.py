...
PUBLIC_CODE_FILES = (
    *KP1979_MATCHER_CODE_FILES,
    ...
    ROOT / "src" / "indusbench" / "nmfa_resampling_common.py",
    ...
    ROOT / "tests" / "test_nmfa_bootstrap_core.py",
    ROOT / "tests" / "test_nmfa_counter_stream.py",
    ROOT / "tests" / "test_nmfa_exact_order.py",
    ROOT / "tests" / "test_nmfa_resampling_core.py",
    ...
    ROOT / "tests" / "verify_nmfa_resampling_installed_distribution.py",
